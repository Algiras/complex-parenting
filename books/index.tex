...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{THE PATTERN REPEATS (But Not Always in Sequence)}, breakable, leftrule=.75mm, colback=white, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, rightrule=.15mm, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, toptitle=1mm, titlerule=0mm, left=2mm, arc=.35mm, bottomrule=.15mm, toprule=.15mm, opacitybacktitle=0.6, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{THE PATTERN REPEATS}, breakable, leftrule=.75mm, colback=white, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, rightrule=.15mm, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, toptitle=1mm, titlerule=0mm, left=2mm, arc=.35mm, bottomrule=.15mm, toprule=.15mm, opacitybacktitle=0.6, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Key Takeaways}, breakable, leftrule=.75mm, colback=white, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, rightrule=.15mm, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, toptitle=1mm, titlerule=0mm, left=2mm, arc=.35mm, bottomrule=.15mm, toprule=.15mm, opacitybacktitle=0.6, opacityback=0]

\textbf{The Big Idea}: The modern Middle East's borders are artificial
colonial constructs, and political Islam (Islamism) emerged as a
reaction to the psychological and political vacuum left by the
Caliphate's abolition.

\textbf{Key Insights}: - \textbf{Sykes-Picot (1916)} drew the map
without regard for ethnic realities. In 1928, a young Egyptian named
Hassan al-Banna gathered six workers in a tea house in Ismailia and
founded the Muslim Brotherhood. He had no army, no wealth, and no
political power. Yet within two decades, his organization would become
the ideological blueprint for every major Islamist movement of the 20th
century---from Hamas to Al-Qaeda to ISIS.
...
\footnotetext{Fromkin, David. \emph{A Peace to End All Peace: The Fall
of the Ottoman Empire and the Creation of the Modern Middle East}. Henry
Holt and Co., 1989. The definitive account of how European powers
reshaped the region.}

\footnotetext{Mitchell, Richard P. \emph{The Society of the Muslim
Brothers}. Oxford University Press, 1969. Mitchell's work remains the
standard reference for the early history of the Brotherhood.}
...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{THE PATTERN REPEATS ACROSS ALL ABRAHAMIC FAITHS}, breakable, leftrule=.75mm, colback=white, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, rightrule=.15mm, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, toptitle=1mm, titlerule=0mm, left=2mm, arc=.35mm, bottomrule=.15mm, toprule=.15mm, opacitybacktitle=0.6, opacityback=0]
...
The 5 Dynamics operated over centuries in Christianity, proving they're
not just a modern Islamic phenomenon.
